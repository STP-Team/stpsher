...
async def sell_settings_getter(
    dialog_manager: DialogManager, **_kwargs
) -> Dict[str, Any]:
    """Геттер для получения выбранных пользователем настроек биржи продаж.
...
async def sell_filters_day_getter(
    dialog_manager: DialogManager, **_kwargs
) -> Dict[str, Any]:
    """Геттер для фильтров по дню для продаж на бирже.
    ...
    match filter_value:
        ...
        case "all":
            filter_description = ""
        case "today":
            filter_description = "<i>Текущий фильтр: Только запросы на сегодня</i>"
        case "tomorrow":
            filter_description = "<i>Текущий фильтр: Только запросы на завтра</i>"
        case "current_week":
            filter_description = (
                "<i>Текущий фильтр: Только запросы на текущей неделе</i>"
            )
        case "current_month":
            filter_description = (
                "<i>Текущий фильтр: Только запросы в текущем месяце</i>"
            )
...
async def sell_filters_shift_getter(
    dialog_manager: DialogManager, **_kwargs
) -> Dict[str, Any]:
    """Геттер для фильтров по смене для продаж на бирже.
