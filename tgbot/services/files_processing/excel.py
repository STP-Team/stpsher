"""Утилиты для быстрого чтения Excel с кэшированием и оптимизированными шаблонами доступа.

Модуль предоставляет высокопроизводительное чтение Excel файлов
с интеллектуальным кэшированием и быстрым поиском.
"""
...
class ExcelReader:
    """Высокопроизводительный читатель Excel с интеллектуальным кэшированием и быстрым поиском."""
    ...
    def find_date_column(self, date) -> Optional[int]:
        """Ультра-быстрый поиск столбца даты с использованием предварительно созданного индекса.
