...
Revision ID: a9e5f8b2c7d1
Revises: f2d8e7a3b6c9
Create Date: 2025-09-06 12:09:00.000000
...
def upgrade() -> None:
    ...
    # Grant privileges
    op.execute("GRANT DELETE, INSERT, SELECT, UPDATE ON KpiDay TO 'stpsher_bot'")


def downgrade() -> None:
    op.drop_table("KpiDay")
